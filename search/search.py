...
def depthFirstSearch(problem):
    ...
    while not stack.isEmpty():
        ...
        if currNode not in nodesVisited:
...
def uniformCostSearch(problem):
    ...
    while not priorityQueue.isEmpty():
        (currNode, path, cost) = priorityQueue.pop()
        if currNode not in nodesVisited:
            nodesVisited.append(currNode)
            if problem.isGoalState(currNode):
                return path
            for (successor, action, stepCost) in problem.getSuccessors(currNode):
                ...
                newPath = path + [action]
                priorityQueue.push((successor, newPath, totalCost), totalCost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not priorityQueue.isEmpty():
        ...
        if currNode not in nodesVisited:
            ...
            for (successor, action, stepCost) in problem.getSuccessors(currNode):
                totalCost = cost + stepCost
                hCost = totalCost + heuristic(successor, problem)
                newPath = path + [action]
                priorityQueue.push((successor, newPath, totalCost), hCost)
